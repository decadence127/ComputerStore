...
export const ACCOUNT_ROUTE = `${API_ROUTE}/account/`;
export const CHANGE_ROLE_ROUTE = `${API_ROUTE}/account/role/`;
...
export const ADDRESS_ROUTE = `${API_ROUTE}/address/`;

//CART API
export const CART_URL = `${API_ROUTE}/cart`;
export const GET_CART_ROUTE = `${API_ROUTE}/cart/user`;
export const CREATE_CART_ROUTE = `${API_ROUTE}/cart/`;
export const EDIT_CART_ROUTE = `${API_ROUTE}/cart/`;

//COMMODITY API
export const COMMODITIES_ROUTE = `${API_ROUTE}/commodity`;
export const COMMODITY_ROUTE = `${API_ROUTE}/commodity/`;

//ORDER API
export const ORDERS_ROUTE = `${API_ROUTE}/order`;
export const ORDER_ROUTE = `${API_ROUTE}/order/`;
